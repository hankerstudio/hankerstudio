...
echo "<script language=javascript>alert('登陆成功！');window.location='feedback.php'</script>";
}
  }
?>
<?php
	...
	header("location:feedback.php"); //跳转到首页
	}
?>
<?php
if($_GET["id"]<>''){
...
$noinfo = implode("@@@",$column);
	...
	echo "<script language=javascript>alert('删除成功！');window.location='feedback.php'</script>";
}
?>
</head>
<body>
...
<table width="550" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#B3B3B3">
  <tr>
    <td height="25" align="center" bgcolor="#EBEBEB"><a href="feedback.php">查看留言</a>&nbsp;|&nbsp;<a href="feedback.php?tj=add">添加留言</a>&nbsp;|&nbsp;<?php if($_SESSION['pwd']==''){echo '<a href="feedback.php?tj=login">留言管理</a>';}else{
echo "<a href='down.php'>数据备份</a>&nbsp;|&nbsp;<a href='feedback.php?tj=logout'>退出管理</a>"; 
}?></td>
  </tr>
</table>
...
$content = file_get_contents("info.txt");
		   ...
		   echo "<script language=javascript>alert('留言成功！');window.location='feedback.php'</script>";
	}
?>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
...
<table width="550" height="20" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td align="left" bgcolor="#FFFFFF">&nbsp;Copyright @ 2013-2113 寒客工作室  ALL Rights Reserved</td>
  </tr>
</table>
</body>
</html>